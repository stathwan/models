...
class FaceGAN:
    def __init__(self,chennel=1):
        self.impath=glob.glob('C:/Users/2017B221/Documents/faceGAN/data/*')    
    ...
    def Generator_model(self):
        model= Sequential()
        model.add(Dense(128, input_shape=self.noise_shape))
        model.add(LeakyReLU())
    ...
    def Generator_Discriminator_model(self):
        ...
        Generator_Discriminator.compile(loss='mse', optimizer='Adam', metrics=['accuracy'])
    ...
    '''
    def train(self,epochs=100000,batch_size=64,save_interval=100):
    ...
    def save_imgs(self,epoch):
        ...
        for i in range(r):
            for j in range(c):
                ...
                axs[i,j].axis('off')
                cnt += 1
        fig.savefig("C:/Users/2017B221/Documents/faceGAN/result/face_%d.png" % epoch)
        plt.close()
        

def main():
    m=FaceGAN()
    m.train(save_interval=500,epochs=100000,batch_size=128)
